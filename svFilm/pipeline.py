# -*- coding: utf-8 -*-
"""编排：L0 分析 -> L1 修正 -> L2 风格 -> L3 局部 -> L4 护栏。
...
from . import analyze, color, config as C, guard, io, local, style, tone
...
def run(path, src=None, max_side=None, cfg=C, out=None, lut=None, keep_stages=False):
    ...
    disp3, l_info = local.apply(disp1, disp2, cfg)                   # L3
